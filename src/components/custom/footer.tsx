...
function selectSocialIcon(url: string) {
  if (url.includes("linkedin")) return <YoutubeIcon className="h-6 w-6" />;
  if (url.includes("github")) return <TwitterIcon className="h-6 w-6" />;
  if (url.includes("jsw")) return <GithubIcon className="h-6 w-6" />;
  return null;
}
